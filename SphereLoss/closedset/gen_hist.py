...
def histogram(net, batch_size, data_dir='/home/noah/SphereLoss/closedset/test', output_path='/home/noah/SphereLoss/closedset/histograms/histogram.png', device=None, bins=50, title="CLOSEDSET: Embedding Similarity Distribution"):
...
if __name__ == '__main__':
    net = net_sphere.resnet(num_classes=423, feature_dim=1024, s=64, m=4).to(torch.device('cuda' if torch.cuda.is_available() else 'cpu'))
    net.load_state_dict(torch.load('/home/noah/SphereLoss/closedset/weights/best_weights.pth'))
    histogram(net, 256)